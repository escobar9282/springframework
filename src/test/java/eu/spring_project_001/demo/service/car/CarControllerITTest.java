...
class CarControllerITTest {
    ...
    {
        Owner owner = new Owner( "aaa", "bbb", 21, "ccc", "ddd", "eee", 111, 2.8, Set.of(), Set.of(), Set.of());
        repo.save(owner);
    }
    ...
    void addCar() throws Exception
    {
        ...
        // when
        mockMvc.perform(post("/cars/add").content(requestYourBody).header("Content-Type",  Arrays.asList("application/json;charset=utf-8"))).andDo(print()).andExpect(status().isCreated());
    }
